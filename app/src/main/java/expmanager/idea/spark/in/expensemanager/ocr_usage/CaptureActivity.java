...
package expmanager.idea.spark.in.expensemanager.ocr_usage;
...
import expmanager.idea.spark.in.expensemanager.ApplicationController;
import expmanager.idea.spark.in.expensemanager.R;
import expmanager.idea.spark.in.expensemanager.ocr_usage.camera.CameraManager;
import expmanager.idea.spark.in.expensemanager.ocr_usage.camera.ShutterButton;
import expmanager.idea.spark.in.expensemanager.ocr_usage.language.LanguageCodeHelper;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
  ...
  boolean handleOcrDecode(final OcrResult ocrResult) {
    ...
    Toast toast = Toast.makeText(this,ocrResult.getText(), Toast.LENGTH_SHORT);
    toast.setGravity(Gravity.TOP, 0, 0);
    toast.show();
   ...
   /* TextView sourceLanguageTextView = (TextView) findViewById(R.id.source_language_text_view);
    ...
    ok.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        ApplicationController.ocrText=ocrResult.getText();
        Intent returnIntent = new Intent();
        returnIntent.putExtra("result",ocrResult.getText());
